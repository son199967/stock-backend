...
public class UploadController {
    ...
    @RequestMapping(value = "", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    public Page<FileMetaData> uploadFile(@PageableDefault Pageable pageable) {
        return fileService.getAllMetaData(pageable);
